  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="lg:grid lg:grid-cols-5 lg:gap-6">
        {/* Left column: balance card + withdraw */}
        <div className="lg:col-span-2 mb-6 lg:mb-0">
          {/* Balance Card */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="relative overflow-hidden bg-gradient-to-br from-brand-green to-brand-emerald rounded-3xl p-8 mb-4"
          >
        ...
        <motion.div
          ...
          className="lg:col-span-3 bg-[var(--c-card)] rounded-2xl border border-[var(--c-border)] p-5"
        >
