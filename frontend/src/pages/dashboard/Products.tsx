    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-white/40 mb-6">No products yet. Add your first listing!</p>
          <Button onClick={() => navigate('/dashboard/products/new')}><Plus className="h-4 w-4" /> Add Product</Button>
        </div>
      ) : (
        <div className="space-y-3">
          {data.map((product, i) => (
            ...
            >
              <div className="h-16 w-16 rounded-xl overflow-hidden bg-brand-700 flex-shrink-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-white/40">{formatCurrency(product.price)} {product.priceUnit}</p>
              </div>
